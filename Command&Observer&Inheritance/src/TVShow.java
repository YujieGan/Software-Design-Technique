 ...
 */
public class TVShow extends Watchable implements Bingeable<Episode> {
	...
	public TVShow(String pTitle, Language pLanguage, String pStudio, Map<String, String> pCast) {
		super(pTitle, pLanguage, pStudio, pCast);
		aNextToWatch = 0;
		aInfo = new HashMap<>();
	}
	 ...
	 * on the file system.
	 */
	public class Episode extends Sequenceable implements Cloneable{
