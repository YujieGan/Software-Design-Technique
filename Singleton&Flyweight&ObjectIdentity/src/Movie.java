...
public class Movie implements Sequenceable<Movie> {
	...
	/**
	 * Creates a movie instance from the file path. Callers must also provide required metadata about the movie.
	 *
	 * @param pPath
	 *            location of the movie on the file system.
	 * @param pTitle
	...
	public static Movie getMovie(File pPath, String pTitle, Language pLanguage, String pStudio) {
		...
		Movie m2 = new Movie(pPath, pTitle, pLanguage, pStudio);
		Movies.add(m2);
		return m2;
	}
